document.write(
  "<h1>Write a program that takes a Negative Floating Point from user & <br> display the following in your browser. <br>a)Number <br>b)Roundoff Value <br>c)Ceil Value <br>d)Floor Value</h1>"
);

var userInput = Number(prompt("Enter Any Negative Value"));
